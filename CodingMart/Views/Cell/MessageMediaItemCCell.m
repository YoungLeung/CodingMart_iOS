...
//        [_imgView doBorderWidth:0.5 color:nil cornerRadius:5.0];
    ...
    if ([_curObj isKindOfClass:[UIImage class]]) {
        ...
        [self.imgView sd_setImageWithURL:currentImageURL placeholderImage:[UIImage imageNamed:@"placeholder_reward_cover_square"] completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
