...
@property (strong, nonatomic) NSNumber *id, *phoneValidation, *emailValidation, *excellent, *evaluation, *infoComplete, *skillComplete, *surveyComplete, *identityPassed, *developerTypeComplete, *contractComplete, *soloDeveloper, *teamDeveloper, *enterpriseDemand, *acceptNewRewardAllNotification, *deposit;
