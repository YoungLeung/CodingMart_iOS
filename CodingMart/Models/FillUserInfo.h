...
@interface FillUserInfo : NSObject

//reward_role 1 个人开发者 2 团队开发者
@property (strong, nonatomic) NSString *name, *email, *mobile, *qq;
@property (strong, nonatomic) NSNumber *province, *city, *district, *free_time, *acceptNewRewardAllNotification, *reward_role, *phone_validation, *email_validation, *enterpriseCertificate;
