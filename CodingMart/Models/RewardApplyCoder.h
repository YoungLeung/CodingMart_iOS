...
@property (strong, nonatomic) NSNumber *role_type_id, *user_id, *reward_role, *status, *apply_id, *excellent, *auth, *identityStatus;
@property (strong, nonatomic) NSNumber *hasPayedStage, *loginUserIsOwner;
